...
final class Hints
{
    ...
    const DATA = array(
        ...
        'editorial-product' => array('hint' => 'One product shown as editorial content, with no price, score, rating or CTA; variants figure, claim, specimen, mention. Product-bound (product_ref).', 'rich_text' => array('body'), 'item_shape' => array('label' => array('type' => 'string', 'description' => 'Attribute name, e.g. "Capacity".'), 'value' => array('type' => 'string'))),
