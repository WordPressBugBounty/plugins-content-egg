...
/***/ "./application/EggBlocks/blocks/quick-picks/src/Edit.js"
/*!**************************************************************!*\
  !*** ./application/EggBlocks/blocks/quick-picks/src/Edit.js ***!
  \**************************************************************/
...
const VARIANT_OPTIONS = [{
  ...
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Alternatives", "content-egg"),
  value: "alternatives"
}, {
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Shelves", "content-egg"),
  value: "shelves"
}, {
...
function createItemId() {
  return `qp-${Date.now()}-${Math.random().toString(36).slice(2, 8)}`;
}
function Edit({
  attributes,
  setAttributes
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
    ...
    nextItems.forEach((item, index) => {
      ...
      if (String(nextItems[index]?.seeded_for || "") === productKey) {
        return;
      }
      const currentTitle = String(nextItems[index]?.title || "").trim();
      const currentSubtitle = String(nextItems[index]?.subtitle || "").trim();
      const currentMerchant = String(nextItems[index]?.merchant || "").trim();
      const currentBadge = String(nextItems[index]?.badge || "").trim();
      const nextPatch = {};
      if (nextSeeded.title !== "" && (currentTitle === "" || currentTitle === previousSeeded.title)) {
        nextPatch.title = nextSeeded.title;
      }
      if (nextSeeded.subtitle !== "" && (currentSubtitle === "" || currentSubtitle === previousSeeded.subtitle)) {
        nextPatch.subtitle = nextSeeded.subtitle;
      }
      if (nextSeeded.merchant !== "" && (currentMerchant === "" || currentMerchant === previousSeeded.merchant)) {
        nextPatch.merchant = nextSeeded.merchant;
      }
      if (nextSeeded.badge !== "" && (currentBadge === "" || currentBadge === previousSeeded.badge)) {
        nextPatch.badge = nextSeeded.badge;
      }
      nextPatch.seeded_for = productKey;
      nextItems[index] = {
        ...nextItems[index],
        ...nextPatch
      };
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarDropdownMenu, {
    ...
    emptyMessage: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("No quick-picks products are currently bound to this block.", "content-egg"),
    ...
    renderItemFields: ({
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Badge", "content-egg"),
      value: item?.badge || "",
      onChange: value => updateItem(currentItem => ({
        ...currentItem,
        badge: value
...
/***/ "./application/EggBlocks/blocks/quick-picks/block.json"
/*!*************************************************************!*\
  !*** ./application/EggBlocks/blocks/quick-picks/block.json ***!
  \*************************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"eggb/quick-picks","version":"1.0.0","title":"Quick Picks","category":"cegg-blocks","icon":"awards","description":"Ranked CE-first shortlist block with multiple product bindings.","textdomain":"content-egg","editorScript":"file:./index.js","render":"file:./render.php","style":["eggb-base","file:./style-min.css"],"attributes":{"variant":{"type":"string","default":"default","enum":["default","compact","alternatives","shelves","grid","highlight"]},"section_label":{"type":"string","default":"Quick picks"},"title":{"type":"string","default":""},"heading_tag":{"type":"string","default":"h2","enum":["h1","h2","h3","h4","div"]},"cta_label":{"type":"string","default":""},"items":{"type":"array","default":[]},"anchor":{"type":"string","default":""},"toc_label":{"type":"string","default":""},"include_in_toc":{"type":"boolean","default":false},"level":{"type":"number","default":2},"color_scheme":{"type":"string","default":"auto","enum":["auto","light","dark"]},"style":{"type":"object","default":{"spacing":{"margin":{"bottom":"1.5rem"}}}}},"supports":{"html":false,"anchor":false,"align":["wide","full"],"spacing":{"margin":["bottom"]}}}');
...
(() => {
/*!***************************************************************!*\
  !*** ./application/EggBlocks/blocks/quick-picks/src/index.js ***!
  \***************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Edit */ "./application/EggBlocks/blocks/quick-picks/src/Edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../block.json */ "./application/EggBlocks/blocks/quick-picks/block.json");
