...
class DefaultVariant
{
    ...
    {
        ?>
        <section class="eggb-block eggb-conclusion eggb-conclusion--default<?php echo $theme_class ? ' ' . esc_attr($theme_class) : ''; ?>"<?php echo $data_theme; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
