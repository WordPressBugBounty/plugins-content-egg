...
/***/ "./application/EggBlocks/blocks/conclusion/src/Edit.js"
/*!*************************************************************!*\
  !*** ./application/EggBlocks/blocks/conclusion/src/Edit.js ***!
  \*************************************************************/
...
function Edit({
  ...
  const updatePoints = nextPoints => setAttributes({
    points: nextPoints
  });
  const addPoint = () => updatePoints([...(points || []), ""]);
  ...
  const updateSteps = nextSteps => setAttributes({
    next_steps: nextSteps
  });
  const addStep = () => updateSteps([...(next_steps || []), {
    text: "",
    url: ""
  }]);
  const updateStep = (index, key, value) => {
    const next = [...(next_steps || [])];
    next[index] = {
      text: "",
      url: "",
      ...(next[index] || {}),
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarDropdownMenu, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Summary", "content-egg"),
    value: summary,
    onChange: value => setAttributes({
      summary: value
    }),
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Points", "content-egg"),
    initialOpen: false
  }, (points || []).map((point, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: index,
    style: {
      display: "flex",
      alignItems: "center",
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Add point", "content-egg"))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Next Steps", "content-egg"),
    initialOpen: false
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Label", "content-egg"),
    value: next_steps_label,
    onChange: value => setAttributes({
      next_steps_label: value
    })
  }), (next_steps || []).map((item, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: index,
    style: {
      marginBottom: index === next_steps.length - 1 ? "0" : "10px",
      paddingBottom: index === next_steps.length - 1 ? "0" : "10px",
      borderBottom: index === next_steps.length - 1 ? "none" : "1px solid #e0e0e0"
    }
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
      display: "flex",
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("URL", "content-egg"),
    value: item?.url || "",
    onChange: value => updateStep(index, "url", value),
    __nextHasNoMarginBottom: true
  }))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    variant: "secondary",
    size: "small",
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Add next step", "content-egg"))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
    ...
    ...blockProps
  }, summary?.trim() ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Disabled, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_shared_js_DebouncedServerSideRender__WEBPACK_IMPORTED_MODULE_4__["default"], {
    block: "eggb/conclusion",
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Add summary text in the sidebar.", "content-egg"))));
}
...
/***/ "./application/EggBlocks/blocks/conclusion/block.json"
/*!************************************************************!*\
  !*** ./application/EggBlocks/blocks/conclusion/block.json ***!
  \************************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"eggb/conclusion","version":"1.0.0","title":"Conclusion","category":"cegg-blocks","icon":"yes","description":"Closing summary with takeaways and next-step links.","textdomain":"content-egg","editorScript":"file:./index.js","render":"file:./render.php","style":["eggb-base","file:./style-min.css"],"attributes":{"variant":{"type":"string","default":"default","enum":["default","compact"]},"section_label":{"type":"string","default":"Conclusion"},"title":{"type":"string","default":""},"heading_tag":{"type":"string","default":"h2","enum":["h1","h2","h3","h4","div"]},"points":{"type":"array","default":[]},"summary":{"type":"string","default":""},"next_steps_label":{"type":"string","default":"Next steps"},"next_steps":{"type":"array","default":[]},"anchor":{"type":"string","default":""},"toc_label":{"type":"string","default":""},"include_in_toc":{"type":"boolean","default":false},"level":{"type":"number","default":2},"color_scheme":{"type":"string","default":"auto","enum":["auto","light","dark"]},"style":{"type":"object","default":{"spacing":{"margin":{"bottom":"1.5rem"}}}}},"supports":{"html":false,"align":["wide","full"],"spacing":{"margin":["bottom"]}}}');
...
(() => {
/*!**************************************************************!*\
  !*** ./application/EggBlocks/blocks/conclusion/src/index.js ***!
  \**************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Edit */ "./application/EggBlocks/blocks/conclusion/src/Edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../block.json */ "./application/EggBlocks/blocks/conclusion/block.json");
