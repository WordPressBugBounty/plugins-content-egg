...
class CardsVariant
{
    ...
    {
        ?>
        <section class="eggb-block eggb-step-list eggb-step-list--cards<?php echo $theme_class ? ' ' . esc_attr($theme_class) : ''; ?>"<?php echo $data_theme; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
            <div class="d-flex flex-column gap-3">
                ...
                <ol class="eggb-sl-list d-flex flex-column gap-2 mb-0">
                    <?php foreach ($step_list['steps'] as $index => $step): ?>
                        <li class="eggb-sl-card eggb-card p-3 p-md-4 d-flex align-items-start gap-3">
