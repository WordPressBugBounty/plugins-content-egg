...
/**
 * Server-side render for eggb/step-list block.
 *
...
echo '<div ' . $wrapper_attributes . '>' . \ContentEgg\application\EggBlocks\blocks\steplist\StepListRenderer::render($attributes) . '</div>';
