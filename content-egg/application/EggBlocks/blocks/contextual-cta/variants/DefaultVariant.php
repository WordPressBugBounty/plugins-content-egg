...
class DefaultVariant
{
    public static function render(array $data, string $theme_class = '', string $data_theme = ''): void
    {
        ...
        $has_actions = ($primary_label !== '' && $primary_url !== '') || ($secondary_label !== '' && $secondary_url !== '') || $primary_meta !== '';
        ?>
        <div class="eggb-block eggb-cta eggb-cta--default<?php echo $theme_class ? ' ' . esc_attr($theme_class) : ''; ?>"<?php echo $data_theme; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
            ...
            <?php if ($has_actions): ?>
                <div class="eggb-cta-actions">
                    <?php if ($primary_label !== '' && $primary_url !== ''): ?>
                        <a href="<?php echo esc_url($primary_url); ?>" class="eggb-cta-primary">
            ...
            <?php if ($context !== ''): ?>
                <div class="eggb-cta-context"><?php echo $context; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div>
            <?php endif; ?>
