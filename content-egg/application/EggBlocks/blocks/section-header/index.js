...
/***/ "./application/EggBlocks/blocks/section-header/src/Edit.js"
/*!*****************************************************************!*\
  !*** ./application/EggBlocks/blocks/section-header/src/Edit.js ***!
  \*****************************************************************/
...
const VARIANT_OPTIONS = [{
  ...
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Accent", "content-egg"),
  value: "accent"
}, {
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Editorial", "content-egg"),
  value: "editorial"
}];
...
function Edit({
  ...
  const hasPreviewContent = (title || "").trim() !== "" || (subtitle || "").trim() !== "" || (kicker || "").trim() !== "" || (meta || "").trim() !== "" || (step_number || "").trim() !== "" || (chips || []).some(chip => (chip || "").trim() !== "");
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarDropdownMenu, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Subtitle", "content-egg"),
    value: subtitle,
    onChange: value => setAttributes({
      subtitle: value
    }),
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Step Number", "content-egg"),
    type: "number",
    value: step_number || "",
    onChange: value => setAttributes({
      step_number: value
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Step Label Text", "content-egg"),
    value: step_label_text,
    onChange: value => setAttributes({
      step_label_text: value
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Kicker", "content-egg"),
    value: kicker,
    onChange: value => setAttributes({
      kicker: value
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextareaControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Meta", "content-egg"),
    value: meta,
    onChange: value => setAttributes({
      meta: value
    }),
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Chips", "content-egg"),
    initialOpen: false
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Add chip", "content-egg"))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Add section header content in the sidebar.", "content-egg")))));
}
...
/***/ "./application/EggBlocks/blocks/section-header/block.json"
/*!****************************************************************!*\
  !*** ./application/EggBlocks/blocks/section-header/block.json ***!
  \****************************************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"eggb/section-header","version":"1.0.0","title":"Section Header","category":"cegg-blocks","icon":"heading","description":"Section heading block for steps, framed editorial sections, and guide anchors.","textdomain":"content-egg","editorScript":"file:./index.js","render":"file:./render.php","style":["eggb-base","file:./style-min.css"],"attributes":{"variant":{"type":"string","default":"default","enum":["default","accent","editorial"]},"step_number":{"type":"string","default":""},"title":{"type":"string","default":""},"heading_tag":{"type":"string","default":"h2","enum":["h1","h2","h3","h4","div"]},"subtitle":{"type":"string","default":""},"step_label_text":{"type":"string","default":"Step"},"kicker":{"type":"string","default":""},"meta":{"type":"string","default":""},"chips":{"type":"array","default":[]},"anchor":{"type":"string","default":""},"toc_label":{"type":"string","default":""},"include_in_toc":{"type":"boolean","default":false},"level":{"type":"number","default":2},"color_scheme":{"type":"string","default":"auto","enum":["auto","light","dark"]},"style":{"type":"object","default":{"spacing":{"margin":{"bottom":"1.5rem"}}}}},"supports":{"html":false,"align":["wide","full"],"spacing":{"margin":["bottom"]}}}');
...
(() => {
/*!******************************************************************!*\
  !*** ./application/EggBlocks/blocks/section-header/src/index.js ***!
  \******************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Edit */ "./application/EggBlocks/blocks/section-header/src/Edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../block.json */ "./application/EggBlocks/blocks/section-header/block.json");
