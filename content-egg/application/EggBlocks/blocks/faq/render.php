...
/**
 * Server-side render for eggb/faq block.
 *
...
require_once __DIR__ . '/variants/FlatVariant.php';
require_once __DIR__ . '/FaqRenderer.php';
...
echo '<div ' . $wrapper_attributes . '>' . \ContentEgg\application\EggBlocks\blocks\faq\FaqRenderer::render($attributes) . '</div>';
