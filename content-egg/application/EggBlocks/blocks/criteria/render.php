...
/**
 * Server-side render for eggb/criteria block.
 *
...
require_once __DIR__ . '/variants/ListVariant.php';
require_once __DIR__ . '/variants/PlainVariant.php';
require_once __DIR__ . '/CriteriaRenderer.php';
...
echo '<div ' . $wrapper_attributes . '>' . \ContentEgg\application\EggBlocks\blocks\criteria\CriteriaRenderer::render($attributes) . '</div>';
