...
/**
 * Server-side render for eggb/intro block.
 *
...
require_once __DIR__ . '/IntroRenderer.php';
...
echo '<div ' . $wrapper_attributes . '>' . \ContentEgg\application\EggBlocks\blocks\intro\IntroRenderer::render($attributes) . '</div>';
