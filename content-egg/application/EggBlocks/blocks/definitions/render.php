...
/**
 * Server-side render for eggb/definitions block.
 *
...
require_once __DIR__ . '/DefinitionsRenderer.php';
...
echo '<div ' . $wrapper_attributes . '>' . \ContentEgg\application\EggBlocks\blocks\definitions\DefinitionsRenderer::render($attributes) . '</div>';
