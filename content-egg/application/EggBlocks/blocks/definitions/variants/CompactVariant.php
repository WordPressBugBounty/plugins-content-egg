...
class CompactVariant
{
    ...
    {
        ?>
        <section class="eggb-block eggb-definitions eggb-definitions--compact<?php echo $theme_class ? ' ' . esc_attr($theme_class) : ''; ?>"<?php echo $data_theme; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
            <div class="d-flex flex-column gap-2">
                ...
                <dl class="d-flex flex-column gap-2 mb-0">
                    <?php foreach ($definitions['items'] as $item): ?>
                        <div class="eggb-df-compact-item d-flex flex-column gap-1">
                            <dt class="eggb-df-compact-term mb-0"><?php echo esc_html($item['term']); ?></dt>
