...
class InlineVariant
{
    ...
    {
        ?>
        <section class="eggb-block eggb-definitions eggb-definitions--inline<?php echo $theme_class ? ' ' . esc_attr($theme_class) : ''; ?>"<?php echo $data_theme; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
            <div class="d-flex flex-column gap-2">
                ...
                <dl class="d-flex flex-column gap-2 mb-0">
                    <?php foreach ($definitions['items'] as $item): ?>
                        <div class="eggb-df-inline-item d-flex flex-wrap align-items-baseline gap-2">
                            <dt class="eggb-df-inline-term mb-0"><?php echo esc_html($item['term']); ?></dt>
