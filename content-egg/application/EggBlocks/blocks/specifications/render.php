...
/**
 * Server-side render for eggb/specifications block.
 *
...
require_once __DIR__ . '/SpecificationsRenderer.php';
...
echo '<div ' . $wrapper_attributes . '>' . \ContentEgg\application\EggBlocks\blocks\specifications\SpecificationsRenderer::render($attributes) . '</div>';
