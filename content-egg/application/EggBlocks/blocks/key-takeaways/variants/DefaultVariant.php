...
class DefaultVariant
{
    ...
    {
        ?>
        <section class="eggb-block eggb-key-takeaways eggb-key-takeaways--default<?php echo $theme_class ? ' ' . esc_attr($theme_class) : ''; ?>"<?php echo $data_theme; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
            <div class="d-flex flex-column gap-3">
                ...
                <ul class="eggb-item-list">
                    <?php foreach ($takeaways['items'] as $item): ?>
                        <li>
                            <?php echo EggbIcons::get('check-circle', 'eggb-item-icon eggb-kt-icon'); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
