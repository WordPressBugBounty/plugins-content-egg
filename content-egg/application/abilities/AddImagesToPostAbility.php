...
/**
 * AddImagesToPostAbility class file
 *
 * @author keywordrush.com <support@keywordrush.com>
 * @link https://www.keywordrush.com
 * @copyright Copyright &copy; 2026 keywordrush.com
 */
final class AddImagesToPostAbility extends AbilityBase
{
    public function name(): string
    {
        return 'content-egg/add-images-to-post';
    }

    public function label(): string
    {
        return __('Add Images to Post', 'content-egg');
    }
    ...
    public function inputSchema(): array
    {
        return array(
            ...
            'properties' => array(
                ...
                'search_token' => array(
                    'type' => 'string',
                    'description' => 'Token from the content-egg/search-images response. When set, items are '
