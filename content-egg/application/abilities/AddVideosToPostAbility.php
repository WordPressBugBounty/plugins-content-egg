...
final class AddVideosToPostAbility extends AbilityBase
{
    ...
    {
        return 'Attaches videos to a post under one active VIDEO module so a '
            . 'content-egg/videos block (or the [content-egg-block] shortcode) can render '
            . 'them. Preferred flow: run content-egg/search-videos, then pass its search_token plus the '
