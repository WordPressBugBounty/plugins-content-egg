...
{
    /** @var PrefillLogger|null */
    protected ?PrefillLogger $logger;

    public function __construct(?PrefillLogger $logger = null)
    {
        $this->logger = $logger;
    }
     ...
     * @return string
     */
    public function resolve(\WP_Post $post, array $config): string
    {
        ...
        switch ($source)
        {
            ...
            case 'gtin_module':
                ...
                return $this->fromModuleData($post, $module_id, 'gtin');
            ...
            case 'ai':
                return $this->fromAI($post, $config);
     ...
     */
    protected function fromAI(\WP_Post $post, array $config): string
    {
        $this->logNotice(__('AI keyword generation is not implemented yet.', 'content-egg'));
        return '';
    }
