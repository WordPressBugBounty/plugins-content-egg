...
<div class="egg-container egg-compare">
    ...
    <?php for ($offset = 0; $offset < count($items); $offset += $length) : ?>
                ...
                <?php foreach ($current_items as $item) : ?>
                    <div class="col-xs-6 col-md-5 products">
                        ...
                        <?php elseif ($item['extra']['customerReviews']['HasReviews'] == 'true') : ?>
                            <iframe src='<?php echo esc_url_raw($item['extra']['customerReviews']['IFrameURL']); ?>' width='100%' height='500'></iframe>
                        <?php endif; ?>
                    </div>
                <?php endforeach; ?>
            </div>
        ...
        <div class="row">
            ...
            <?php foreach ($current_items as $item) : ?>
                <div class="col-xs-6 col-md-5 text-center">
                    <a<?php TemplateHelper::printRel(); ?> target="_blank" href="<?php echo esc_url_raw($item['url']); ?>" class="btn btn-danger"><?php TemplateHelper::buyNowBtnText(true, $item); ?></a>
                </div>
            <?php endforeach; ?>
        </div>
